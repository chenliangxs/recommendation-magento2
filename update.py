...
class Update():
    ...
    def pickOrderRange(self, start, end):
        ...
        sqlfetchProCat = """SELECT category_id, product_id FROM catalog_category_product
                        WHERE product_id IN 
                        (SELECT product_id FROM rec_index_product_mapping)"""
        
        #truncate queries
        sqlemptycount = "TRUNCATE TABLE rec_user_product_count"
        sqlemptyproduct = "TRUNCATE TABLE rec_index_product_mapping"
        sqlemptycustomer = "TRUNCATE TABLE rec_index_customer_mapping"
        sqlemptycategory = "TRUNCATE TABLE rec_index_category_mapping"
        ...
        sqlProductMapping = "INSERT INTO rec_index_product_mapping (product_id) values (%s)"
        sqlCustomerMapping = "INSERT INTO rec_index_customer_mapping (customer_id) values (%s)"
        sqlCategoryMapping = "INSERT INTO rec_index_category_mapping (category_id) values (%s)"
